...
ALTER TABLE transaction_id_seq OWNER TO jump;

CREATE TABLE transaction_status (
    status TEXT NOT NULL,
    CONSTRAINT transaction_status_unique UNIQUE (status)
);
...
CREATE TABLE transactions (
       ...
       status TEXT REFERENCES transaction_status (status) DEFAULT 'rejected',
       amount FLOAT NOT NULL,
